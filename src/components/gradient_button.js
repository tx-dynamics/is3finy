...
import LinearGradient from 'react-native-linear-gradient';
 ...
 export default function gradient_button({ navigation,txt,disable }) {
    ...
    return(
        ...
        {disable?
            ...
            :
            <TouchableOpacity onPress={navigation} style={{width:159,alignSelf:'center',alignItems:'center',justifyContent:'center'}} >
                <LinearGradient
                    start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#7CFF04', '#00AE55']} 
                    style={{width:159,height:51,borderRadius:10,justifyContent:'center',alignItems:'center'}}
                >
                    <Text  style={{alignSelf:"center",justifyContent:'center',fontSize:18,fontWeight:'500',fontFamily:'Poppins',color:'white'}}>{txt}</Text>
                </LinearGradient>
            </TouchableOpacity>
